...
import programmingFundaments from '../../../public/programming_fundamentals.jpg'
...
const Compulsory = () => {
  return (
    <div className="xl:w-[1300px] lg:w-[90%] w-[95%] m-auto mt-10 mb-10">
      ...
      <div className="grid xl-lg:grid-cols-4 sm:grid-cols-1 grid-cols-1 xl-lg:gap-10 gap-5 mt-10">
        <Link href={"/compulsory/1"} className="hover:scale-105 duration-200 transition-all">
          <div className="overflow-hidden h-fit box_shadow rounded-lg flex flex-col justify-center items-center text-center text-zinc-600 text-lg font-bold">
            <div>
               <Image alt="programing fundamentals" src={programmingFundaments} className="object-cover w-full" height={'300'}  />
